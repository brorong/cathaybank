...
# 🤖 Gemini AI 初始化設定區
# ==========================================
# ⚠️ 請在這裡貼上您剛剛測試成功的 API Key
# 注意：正式部署到外部伺服器時，請務必改回使用 os.environ.get("GEMINI_API_KEY") 以保安全
MY_API_KEY = "AIzaSyAWruVtnHnfO6UDeyeHfXpretVzWn1O37k".strip()

# 就是這行！我們在這裡定義了 client，讓下方的程式可以呼叫它
